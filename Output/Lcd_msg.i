...
#line 72 "Header\LCD_MSG.H" /0
 
#line 9 "Code\Lcd_msg.c" /0
...
#line 17 "Code\Lcd_msg.c" /0
 ...
 if(!bRIGHT_KEY)
 ucKeyState=ucKeyState|0x08;
 if(!bLEFT_KEY)
 ucKeyState=ucKeyState|0x60;
 if(!(M512_Port60&0x01))
 ucKeyState=ucKeyState|0x20;
 
 
 if(!(M512_Port54&0x01))
 ucKeyState=ucKeyState|0x10;
 if(!(M512_Port55&0x01))
 ucKeyState=ucKeyState|0x01;
...
#line 174 "Code\Lcd_msg.c" /0
 
 if (bPower_Status)
 {
 if (0x10 & ucP3_Curr)
 {
 if ((ucP3_Prev ^ ucP3_Curr) & 0x10)
 {
 Delay_Xms(20);
 ...
 {
 if ((0x08| 0x10 ) == ucP3_Curr) 		 
 {
 stGUD3.TV_SETTING |= 0x08; 
 Save_GUD3();
 return 0x80;
 }
 
 else if ((0 == ucMode_Curr) &&((0x60 | 0x10) == ucP3_Curr))      
 {	 
 stGUD3.TV_SETTING = stGUD3.TV_SETTING | 0x20;  
 Save_GUD3();
 return 0x80;
 }         
 
 else if (0x10 & ucP3_Curr)
 {
 if ((ucP3_Prev ^ ucP3_Curr) & 0x10)
 {
 ucKey_Issued    = 0;
 ...
 ucNotify        = (ucP3_Curr == 0x08) ? 0x03 : 0x04;   
 ucKey_Repeat    = 15;
 }
 else
 {
...
#line 412 "Code\Lcd_msg.c" /1
 
 
 
#line 415 "Code\Lcd_msg.c" /0
 break;
 }
 ...
 RTDSetBit(0x6C, 0x00, 0x00);
 RTDSetBit(0x6D, 0x3f, 0x40);	 
 RTDSetBit(0x6C, 0x00, 0x00);
 RTDSetBit(0x6D, 0x3f, 0x80);	 
 RTDSetBit(0x6C, 0x00, 0x00);
 
 if (200 < usTaskCnt)    Show_Note();
 }
...
#line 551 "Code\Lcd_msg.c" /1
 
 
#line 553 "Code\Lcd_msg.c" /0
 }
 else if (1 == (stGUD1.INPUT_SOURCE & 0x07))
 Change_Source(2);
 else if (2 == (stGUD1.INPUT_SOURCE & 0x07))
 Change_Source(3);
 else if (3 == (stGUD1.INPUT_SOURCE & 0x07))
 {
 
#line 561 "Code\Lcd_msg.c" /1
 
 
#line 563 "Code\Lcd_msg.c" /0
 Change_Source(5);
 
 }
 else if (4 == (stGUD1.INPUT_SOURCE & 0x07))
 {
 Change_Source(5);
 }
 else
...
#line 664 "Code\Lcd_msg.c" /1
 
 
#line 666 "Code\Lcd_msg.c" /0
 }
 }
 }
 break;
