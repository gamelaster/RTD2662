...
unsigned char code FreeV[]  =
{
    ...
    7,      Y_INC,  DPLL_CTRL_D0,       0x28,0x37,0x33,0x04,        //DCLK = 100MHz		//anson
...
//      HF_min, HF_max, VL_min, VL_max, HF_std, VS+1
    {   414,    436,    798,    814,    423,    3+1     }, //30:1024*768*72hz	//anson 05_0321 add
    {   399,    421,    795,    811,    408,    3+1     }, //31:1024*768*74hz
//      HF_min, HF_max, VL_min, VL_max, HF_std, VS+1
    {   400,    422,    791,    807,    409,    3+1     }, //32:1024*768*75hz
    {   350,    370,    799,    815,    358,    3+1     }, //33:1024*768*85hz
    {   339,    358,    834,    850,    347,    8+1     }, //34:1024*800*84hz
    {   356,    376,    891,    907,    364,    3+1     }, //35:1152*864*75hz
    {   350,    370,    906,    922,    358,    3+1     }, //36:1152*870*75hz
    {   389,    411,    928,    944,    398,    4+1     }, //37:1152*900*66hz
    {   335,    354,    934,    950,    343,    8+1     }, //38:1152*900*76hz
    {   401,    423,    991,    1007,   410,    3+1     }, //39:1280*960*60hz
    {   280,    295,    1002,   1018,   286,    3+1     }, //40:1280*960*85hz
    {   376,    396,    1057,   1073,   384,    3+1     }, //41:1280*1024*60hz
    {   312,    329,    1060,   1076,   319,    3+1     }, //42:1280*1024*72hz
    {   296,    313,    1057,   1073,   303,    8+1     }, //43:1280*1024*76hz
    {   300,    317,    1057,   1073,   307,    3+1     }, //44:1280*1024*75hz
    {   264,    279,    1063,   1079,   270,    3+1     }, //45:1280*1024*85hz
    {   321,    339,    1241,   1257,   328,    3+1     }, //46:1600*1200*60hz

    {   0,      0,      0,      0,      0,      0       }, //47:Mode reserved 00
    {   0,      0,      0,      0,      0,      0       }, //48:Mode reserved 01
    {   0,      0,      0,      0,      0,      0       }, //49:Mode reserved 02
    {   0,      0,      0,      0,      0,      0       }, //50:Mode reserved 03

    {   642,    1230,   418,    497,    0,      2+1     }, //51:NewMode720x400
    {   535,    1025,   498,    637,    0,      2+1     }, //52:NewMode640x480
    {   428,    820,    618,    785,    0,      2+1     }, //53:NewMode800x600
    {   334,    641,    786,    881,    0,      2+1     }, //54:NewMode1024x768
    {   297,    570,    882,    917,    0,      2+1     }, //55:NewMode1152x864
    {   285,    547,    918,    977,    0,      2+1     }, //56:NewMode1152x900
    {   267,    513,    978,    1041,   0,      2+1     }, //57:NewMode1280x960
    {   251,    481,    1042,   1217,   0,      2+1     }, //58:NewMode1280x1024
    {   292,    559,    1218,   1328,   0,      2+1     }, //59:NewMode1600x1200
};
...
unsigned int code Mode_Preset[][5]   =
{
    ...
    //  DH_TOTAL    DH_ACT_WID  DV_ACT_LEN      DCLK_M/N    IVS_DELAY
    {   1408,       1280,       1024,           0,          7       }, //30:1024*768*72hz	//anson 05_0321 add
    {   1408,       1280,       1024,           0,          7       }, //31:1024*768*74hz
    //  DH_TOTAL    DH_ACT_WID  DV_ACT_LEN      DCLK_M/N    IVS_DELAY
    {   1408,       1280,       1024,           0,          7       }, //32:1024*768*75hz
    {   1408,       1280,       1024,           0,          7       }, //33:1024*768*85hz
    {   1408,       1280,       1024,           0,          7       }, //34:1024*800*84hz
    {   1408,       1280,       1024,           0,          7       }, //35:1152*864*75hz
    {   1408,       1280,       1024,           0,          7       }, //36:1152*870*75hz
    {   1408,       1280,       1024,           0,          7       }, //37:1152*900*66hz
    {   1408,       1280,       1024,           0,          7       }, //38:1152*900*76hz
    {   1408,       1280,       1024,           0,          7       }, //39:1280*960*60hz
    {   1408,       1280,       1024,           0,          7       }, //40:1280*960*85hz
    {   1408,       1280,       1024,           0,          7       }, //41:1280*1024*60hz
    {   1408,       1280,       1024,           0,          7       }, //42:1280*1024*72hz
    {   1408,       1280,       1024,           0,          7       }, //43:1280*1024*76hz
    {   1408,       1280,       1024,           0,          7       }, //44:1280*1024*75hz
    {   1408,       1280,       1024,           0,          7       }, //45:1280*1024*85hz
    {   1408,       1280,       1024,           0,          7       }, //46:1600*1200*60hz

    //  Reserved mode
    {   1408,       1280,       1024,           0,          0       }, //47:Mode reserved 00
    {   1408,       1280,       1024,           0,          0       }, //48:Mode reserved 01
    {   1408,       1280,       1024,           0,          0       }, //49:Mode reserved 02
    {   1408,       1280,       1024,           0,          0       }, //50:Mode reserved 03

    //  Unknown user mode
    {   1408,       1280,       1024,           0,          3       }, //51:NewMode720x400
    {   1408,       1280,       1024,           0,          3       }, //52:NewMode640x480
    {   1408,       1280,       1024,           0,          3       }, //53:NewMode800x600
    {   1408,       1280,       1024,           0,          3       }, //54:NewMode1024x768
    {   1408,       1280,       1024,           0,          3       }, //55:NewMode1152x864
    {   1408,       1280,       1024,           0,          3       }, //56:NewMode1152x900
    {   1408,       1280,       1024,           0,          3       }, //57:NewMode1280x960
    {   1408,       1280,       1024,           0,          3       }, //58:NewMode1280x1024
    {   1408,       1280,       1024,           0,          3       }, //59:NewMode1600x1200
    
    //  Safe display mode
    {   1408,       1280,       1024,           0,          3       }, //60:Undefined SU mode
    {   1408,       1280,       1024,           0,          3       }, //61:Undefined SD mode
};
