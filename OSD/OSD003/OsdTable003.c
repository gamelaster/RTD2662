...
code SMenuItem g_tMenuItem[] = 
{
    ...
    {
        _EN_PUB_KEYEVENT | _DISABLE_NOT_SHOW | _KEYMAP_EN_IN_NOSIGNAL,       //BYTE Option;
    ...
    // Short Cut menu\Bightness(_MI_SC_BRIGHTNESS)
    {
        _EN_PUB_KEYEVENT,       //BYTE Option;
        tKOShortCutVolume001,            //SKeyToOsdEvent *KeyMsgToOsdEvnet;
    ...
    //001 menu/ _MI_001_CONTRAST
    {
        _EN_PUB_KEYEVENT,       //BYTE Option;
        tKOSubMenu,            //SKeyToOsdEvent *KeyMsgToOsdEvnet;
        M001Proc,          //funcpProc Proc;
        CEnable,                //funcpEnable Enable;
    },
    //001 menu/_MI_001_BRIGHTNESS
    {
        _EN_PUB_KEYEVENT,       //BYTE Option;
        tKOSubMenu,            //SKeyToOsdEvent *KeyMsgToOsdEvnet;
        M001Proc,          //funcpProc Proc;
    ...
    //001 menu/_MI_001_DISPLAY_RATIO 
    {
        _EN_PUB_KEYEVENT,       //BYTE Option;
        tKOSubMenu,            //SKeyToOsdEvent *KeyMsgToOsdEvnet;
        M001Proc,          //funcpProc Proc;
    ...
    //001 menu/ _MI_001_RESET
    {
        _EN_PUB_KEYEVENT,       //BYTE Option;
        tKOSubMenu2,            //SKeyToOsdEvent *KeyMsgToOsdEvnet;
        M001Proc,          //funcpProc Proc;
        CEnable,                //funcpEnable Enable;
    },
   
       //001 menu/ _MI_001_EXIT
    {
        _EN_PUB_KEYEVENT,       //BYTE Option;
        tKOSubMenu,            //SKeyToOsdEvent *KeyMsgToOsdEvnet;
        M001Proc,          //funcpProc Proc;
...
//------------------------------------------------------------
    ...
    /*    //Factory menu/(BURNIN_ON) _MI_FAC_BURNIN_ON
    {
        _EN_PUB_KEYEVENT,       //BYTE Option;
        tKOMainMenu,            //SKeyToOsdEvent *KeyMsgToOsdEvnet;
        MFacBurninProc,        //funcpProc Proc;
        CEnable,                //funcpEnable Enable;
    },
        //Factory menu/(BURNIN_OFF) _MI_FAC_BURNIN_OFF
    {
        _EN_PUB_KEYEVENT,       //BYTE Option;
        tKOMainMenu,            //SKeyToOsdEvent *KeyMsgToOsdEvnet;
        MFacBurninProc,        //funcpProc Proc;
