...
#define DISP_EO_SWAP        0x20
#define DISP_RB_SWAP        0x00//0x10
#define DISP_ML_SWAP        0x00//0x08
///////////////////////////////////////////////////////////////////
...
//    6,      Y_INC,  PATTERN_GEN_6C,     0x00,0x83 | DISP_EO_SWAP | DISP_RB_SWAP | DISP_ML_SWAP,0x00,
    6,      Y_INC,  PATTERN_GEN_6C,     0x00,0x33,0x00,
...
// For RSDS TCON START
//--------------------------------------------------------------------
	5,      Y_INC,  TC_ADDR_PORT_95,    0x20,0x0c,  // FXDIO TCON3
    5,      Y_INC,  TC_ADDR_PORT_95,    0x21,0x40,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x22,0x0c,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x23,0xa0,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x24,0x22,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x25,0xa1,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x26,0x80,    




   	5,      Y_INC,  TC_ADDR_PORT_95,    0x28,0x0c,  // XSTB TCON4
    5,      Y_INC,  TC_ADDR_PORT_95,    0x29,0x40,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x2A,0X0c,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x2B,0x35,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x2C,0x22,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x2D,0xac,
...
/*
	...
	5,      Y_INC,  TC_ADDR_PORT_95,    0x58,0x0d,	  // YDIO TCON10
    5,      Y_INC,  TC_ADDR_PORT_95,    0x59,0x00,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x5A,0x0f,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x5B,0xd0,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x5C,0x33,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x5D,0xd7,
    5,      Y_INC,  TC_ADDR_PORT_95,    0x5E,0x88,    
...
#if (SPREAD_SPECTRUM)
    8,  Y_INC,  DPLL_CTRL_D0,       0x09, 0x9a, 0x52, 0x0a, 0xf7,
#else    
    8,  Y_INC,  DPLL_CTRL_D0,       0x11, 0x9a, 0x52, 0x2f, 0x06,
#endif
...
#if (SPREAD_SPECTRUM)
    8,  Y_INC,  DPLL_CTRL_D0,       0x09, 0x82, 0x52, 0x0b, 0xf7,
#else    
    8,  Y_INC,  DPLL_CTRL_D0,       0x11, 0x82, 0x52, 0x2f, 0x06,
#endif
